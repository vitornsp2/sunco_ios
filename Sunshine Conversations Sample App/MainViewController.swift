...
final class MainViewController: UIViewController {
    ...
    @IBAction func loginTapped(_ send: UIButton) {
        SunshineConversationsWrapper.shared.login()
    }
    
    @IBAction func logoutTapped(_ send: UIButton) {
        SunshineConversationsWrapper.shared.logout()
    }
